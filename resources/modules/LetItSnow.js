...
class SnowBackground {
  ...
  constructor( { particlesCount = 60, particlesParams = {}, createStorms = true} = {} ){
  ...
  static particlesDefaultParams = {
    ...
    radius:  () => Math.random() * 12.3 + 0.3,
    speedX:  () => Math.random() * 9 - 4,
...
class Particle {
  constructor({ opacity = 1, radius = 7, x = 0, y = 0, speedX, speedY }){
    ...
    this.color   = getComputedStyle(document.documentElement).getPropertyValue("--mainColor");
  }
